package com.haad.cv.activities;
...
import com.haad.cv.adapters.ViewPagerAdapter;
import com.haad.cv.base.R;
import com.haad.cv.fragments.AboutFragment;
import com.haad.cv.fragments.EducationFragment;
import com.haad.cv.fragments.ProfessionFragment;
...
public class ScrollingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.get().load(R.drawable.pfp).into(profileImage);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            i.putExtra(android.content.Intent.EXTRA_TEXT, "https://haadfida.github.io/resume/");
